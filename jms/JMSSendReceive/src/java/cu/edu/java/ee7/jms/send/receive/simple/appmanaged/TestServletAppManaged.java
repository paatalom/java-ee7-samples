...
@WebServlet(urlPatterns = {"/TestServletAppManaged"})
public class TestServletAppManaged extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>The test message over app-managed JMSContext</h1>");
            ...
            String meesageReceived = appManagedReceiver.receiveMessage();
