...
@NamedStoredProcedureQuery(
        name = "mySP", 
        procedureName = "top_movies", 
        resultClasses = {cu.edu.java.ee7.jpa.storedprocedure.Movie.class},
        parameters = {
            @StoredProcedureParameter(mode = ParameterMode.IN, name = "rownum", type = Integer.class)
        }
)
