...
public class TestServlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Adding/Removing items from Stateful Bean (without Interface)</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Adding/Removing items from Stateful Bean (without Interface)</h1>");
